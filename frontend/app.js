...
async function renderDashboard(content) {
    ...
    <section class="dashboard-studio">
      <div class="studio-head">
        <div class="studio-head-copy">
          <div class="eyebrow">VisionID / Command Center</div>
          <h1 class="studio-title">Face Intelligence <span>Studio</span></h1>
          <p class="studio-sub">A premium operator workspace for authorized identity checks, similarity decisions and evaluation. Live recognition remains available from the studio without changing the underlying detection or storage pipeline.</p>
        </div>
        <div class="studio-session"><span class="session-ring"></span>LOCAL INFERENCE · SECURE SESSION</div>
      </div>

      <div class="studio-grid">
        <aside class="panel">
          <div class="panel-head"><div class="panel-title">Operator profile</div><div class="panel-kicker">ACTIVE</div></div>
          <div class="panel-item">
            <strong>Authorized workspace</strong>
            <span>Identity operations are handled through the existing SQLite-backed VisionID service.</span>
          </div>
          <div class="panel-stack" style="margin-top:9px">
            <a class="panel-item" href="#/recognize"><strong>Live recognition</strong><span>Upload an image or launch the webcam scanner.</span></a>
            <a class="panel-item" href="#/enroll"><strong>Enroll identity</strong><span>Create or extend a biometric reference profile.</span></a>
            <a class="panel-item" href="#/people"><strong>People directory</strong><span>Review currently enrolled identities.</span></a>
          </div>
          <div class="panel-head" style="margin-top:15px;margin-bottom:4px"><div class="panel-title">Session telemetry</div></div>
          <div class="mini-stat"><span>Enrolled identities</span><b id="dash-enrolled">—</b></div>
          <div class="mini-stat"><span>Recognition attempts</span><b id="dash-attempts">—</b></div>
          <div class="mini-stat"><span>Successful matches</span><b id="dash-success">—</b></div>
          <div class="mini-stat"><span>Unknown faces</span><b id="dash-unknown">—</b></div>
        </aside>

        <section class="stage-card">
          <div class="stage-top">
            <div class="stage-label">Identity visualization · live signal</div>
            <div class="stage-status">system ready</div>
          </div>
          <div class="face-stage" aria-label="VisionID face intelligence visualization">
            ...
            <svg class="face-svg" viewBox="0 0 360 420" role="img" aria-label="Stylized face analysis mesh">
              <defs>
                <linearGradient id="faceStroke" x1="0" x2="1" y1="0" y2="1">
                  <stop offset="0" stop-color="#69dbff" stop-opacity=".92"/>
                  <stop offset=".52" stop-color="#d9f7ff" stop-opacity=".80"/>
                  <stop offset="1" stop-color="#ef7849" stop-opacity=".94"/>
                </linearGradient>
                <radialGradient id="faceFill" cx="50%" cy="30%" r="72%">
                  <stop offset="0" stop-color="#2a7698" stop-opacity=".27"/>
                  <stop offset=".62" stop-color="#09141b" stop-opacity=".14"/>
                  <stop offset="1" stop-color="#02060a" stop-opacity=".03"/>
                </radialGradient>
              ...
              <path d="M180 22 C103 22 61 82 66 167 C72 277 104 355 180 392 C256 355 288 277 294 167 C299 82 257 22 180 22 Z" fill="url(#faceFill)" stroke="url(#faceStroke)" stroke-width="2" opacity=".78" filter="url(#faceGlow)"/>
              <path d="M103 156 Q135 134 164 153 M197 153 Q226 134 257 156" fill="none" stroke="#b9ecff" stroke-opacity=".66" stroke-width="2" stroke-linecap="round"/>
              <ellipse cx="137" cy="165" rx="17" ry="10" fill="none" stroke="#79dfff" stroke-opacity=".68" stroke-width="1.6"/>
              <ellipse cx="223" cy="165" rx="17" ry="10" fill="none" stroke="#79dfff" stroke-opacity=".68" stroke-width="1.6"/>
              <circle cx="141" cy="165" r="3.3" fill="#f3fbff"/><circle cx="219" cy="165" r="3.3" fill="#f3fbff"/>
              <path d="M180 171 C169 196 166 218 180 230 C193 218 191 196 180 171 Z" fill="none" stroke="#9de8ff" stroke-opacity=".55" stroke-width="1.6"/>
              <path d="M146 266 Q180 284 214 266" fill="none" stroke="#f1a37d" stroke-opacity=".75" stroke-width="2" stroke-linecap="round"/>
              <path d="M155 272 Q180 282 205 272" fill="none" stroke="#65d8ff" stroke-opacity=".42" stroke-width="1"/>
              <path d="M104 103 Q180 70 256 103 M84 133 Q180 100 276 133 M75 197 Q180 165 285 197 M84 255 Q180 224 276 255 M103 313 Q180 284 257 313" fill="none" stroke="#7fddff" stroke-opacity=".18" stroke-width="1"/>
              <path d="M117 67 Q180 155 243 67 M92 97 Q180 198 268 97 M83 159 Q180 244 277 159 M92 228 Q180 293 268 228 M117 298 Q180 346 243 298" fill="none" stroke="#ed8a5c" stroke-opacity=".14" stroke-width="1"/>
              <g fill="#a6edff" opacity=".9">
                <circle cx="106" cy="130" r="2"/><circle cx="137" cy="120" r="2"/><circle cx="170" cy="113" r="2"/><circle cx="204" cy="113" r="2"/><circle cx="237" cy="120" r="2"/><circle cx="254" cy="130" r="2"/>
                <circle cx="117" cy="207" r="2"/><circle cx="145" cy="220" r="2"/><circle cx="180" cy="231" r="2.2"/><circle cx="215" cy="220" r="2"/><circle cx="243" cy="207" r="2"/>
                <circle cx="126" cy="270" r="2"/><circle cx="153" cy="284" r="2"/><circle cx="180" cy="290" r="2.2"/><circle cx="207" cy="284" r="2"/><circle cx="234" cy="270" r="2"/>
              </g>
              <g fill="none" stroke="#62d6ff" stroke-opacity=".16">
                <path d="M66 167 H294"/><path d="M85 240 H275"/><path d="M120 80 V330"/><path d="M180 45 V380"/><path d="M240 80 V330"/>
              </g>
            </svg>
            <div class="stage-hud">
              <div class="hud-chip"><span>Detector</span><b>MTCNN</b></div>
              <div class="hud-chip"><span>Embedding</span><b>512-D · VGGFACE2</b></div>
              <div class="hud-chip"><span>Decision</span><b id="dash-decision">READY</b></div>
            </div>
          </div>
        </section>

        <aside class="panel">
          <div class="panel-head"><div class="panel-title">Live analysis</div><div class="panel-kicker">MONITOR</div></div>
          <div class="insight-meter">
            <div class="meter-ring">
              <div class="meter-content"><b id="dash-rate">—</b><span>acceptance rate</span></div>
            </div>
            <div class="insight-row"><span>Current threshold</span><b id="dash-threshold">—</b></div>
            <div class="insight-row"><span>Backend</span><b>ONLINE</b></div>
            <div class="insight-row"><span>Storage</span><b>SQLITE</b></div>
          </div>
          <div class="panel-head" style="margin-top:4px;margin-bottom:7px"><div class="panel-title">Quick actions</div></div>
          <div class="quick-actions">
            <a class="btn btn-primary" href="#/recognize"><span>◎ Start recognition</span><span>→</span></a>
            <a class="btn" href="#/enroll"><span>＋ Enroll identity</span><span>→</span></a>
            <a class="btn" href="#/evaluation"><span>∿ Run evaluation</span><span>→</span></a>
          </div>
          <div class="note-box" style="margin-top:13px"><span>Threshold control remains live on the Recognize page and continues to use the existing backend decision policy.</span></div>
        </aside>
      </div>

      <div class="studio-bottom">
        <div class="bottom-strip">
          <div class="bottom-left"><div class="bottom-icon">◌</div><div><b>Recent recognition activity</b><span>Latest server-side attempts</span></div></div>
          <div class="bottom-meter"><div class="bottom-meter-line"><i id="dash-activity-meter"></i></div></div>
          <a class="btn btn-sm" href="#/recognize">Open scanner →</a>
        </div>
        <div class="bottom-strip">
          <div class="bottom-left"><div class="bottom-icon">◈</div><div><b>Decision guardrail</b><span>Cosine similarity threshold</span></div></div>
          <div style="text-align:right"><b id="dash-thr-bottom">—</b><br/><span>current threshold</span></div>
          <a class="btn btn-sm" href="#/evaluation">Evaluation lab →</a>
        </div>
      </div>

      <div class="card" style="margin-top:14px">
        <div class="section-title">Recent recognition log</div>
        <div class="section-sub" id="activity-count">Latest attempts from the existing activity store</div>
  ...
  document.getElementById("dash-enrolled").textContent = stats.enrolled_people;
  document.getElementById("dash-attempts").textContent = stats.recognition_attempts;
  document.getElementById("dash-success").textContent = stats.successful_matches;
  document.getElementById("dash-unknown").textContent = stats.unknown_faces;
  document.getElementById("dash-rate").textContent = stats.acceptance_rate + "%";
  document.getElementById("dash-threshold").textContent = Math.round(stats.threshold * 100) + "%";
  document.getElementById("dash-thr-bottom").textContent = Math.round(stats.threshold * 100) + "%";
  document.getElementById("dash-decision").textContent = stats.recognition_attempts ? "MONITORING" : "READY";
  const total = Number(stats.recognition_attempts || 0);
  const ratio = total ? Math.max(6, Math.min(100, Math.round((Number(stats.successful_matches || 0) / total) * 100))) : 6;
  document.getElementById("dash-activity-meter").style.width = ratio + "%";

  const list = document.getElementById("activity-list");
  document.getElementById("activity-count").textContent = activity.activity.length ? `${activity.activity.length} most recent attempt${activity.activity.length === 1 ? "" : "s"}` : "No attempts recorded yet";
